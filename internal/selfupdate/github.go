...
const githubRepo = "mewisme/MewAgents"
...
func fetchLatestRelease() (ghRelease, error) {
	...
	req.Header.Set("User-Agent", "mewagents-selfupdate")
...
func assetFileName(tag string) string {
	...
	return fmt.Sprintf("mewagents_%s_%s_%s.%s", v, runtime.GOOS, runtime.GOARCH, ext)
}
